...
public class RecoverPasswordPage extends Base {
    private final By SIGN_IN_LINK = By.className("login");

    private final By ACCOUNT_LINK = By.xpath("//*[@id=\"header\"]/div[2]/div/div/nav/div[1]/a");
    private final By ACCOUNT_LINK2 = By.className("account");
    ...
    private final By SIGN_IN_BUTTON = By.id("submitAccount");
